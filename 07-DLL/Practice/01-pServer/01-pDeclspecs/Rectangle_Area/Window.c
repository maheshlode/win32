...
LRESULT CALLBACK WndProc(HWND hwnd, UINT iMsg, WPARAM wParam, LPARAM lParam)
{
	...
	{
		case WM_CREATE:
			iRectArea=MakeRectArea(iLength, iBreadth);
			wsprintf(str,TEXT("Area of rectangle with Length = %d and Breadth = %d is %d"),iLength,iBreadth,iRectArea);
			MessageBox(hwnd,str,TEXT("Calculation of Area of Rectangle"),MB_OK);
			break;
		case WM_DESTROY:
			PostQuitMessage(0);
			break;
